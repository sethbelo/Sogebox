                ...
                <div class="card border-top border-0 border-white">
                    <div class="card-body p-5">
                        ...
                        <form class="row g-3" enctype="multipart/form-data" method="post"
                            id="jQueryValidationClientForm" action="{{ route('clients.store') }}">
                            @csrf
                            <!-- Nom complet -->
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nom"
                                        class="bg-custom-dark form-control border-start-0" id="inputFirstName"
                                        placeholder="Entrer le nom complet du client" required />
                                </div>
                            </div>
