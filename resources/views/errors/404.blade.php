...
<head>
	...
	<title>Sogebox : Ressource non trouvee</title>
</head>
					...
					<div class="row g-0">
						<div class="col col-xl-5">
							<div class="card-body p-4">
								...
								<div class="mt-5"> <a href="{{ route('dashboard') }}" class="btn btn-light btn-lg px-md-5 radius-30">Dashboard</a>
									<a href="{{ route('dashboard') }}" class="btn btn-light btn-lg ms-3 px-md-5 radius-30">Back</a>
								</div>
							</div>
						</div>
						<div class="col-xl-7">
							<img src="https://cdn.shopify.com/s/files/1/0249/6376/files/meilleures_pages_404.jpg?v=1562946648" class="img-fluid" alt="">
						</div>
					</div>
					<!--end row-->
				</div>
